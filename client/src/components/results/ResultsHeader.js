...
const ResultsHeader = ({cityData}) => {
    ...
    return (
        <Fragment>
            ...
            {data && data.current.pollution.aqius > 50 && data.current.pollution.aqius < 101 && <ModBanner />}
            {data && data.current.pollution.aqius > 100 && data.current.pollution.aqius < 151 && <SensitiveBanner />}
            {data && data.current.pollution.aqius > 151 && data.current.pollution.aqius < 201 && <BadBanner />}
            {data && data.current.pollution.aqius > 201 && data.current.pollution.aqius < 301 && <VeryBadBanner />}
