    ...
    <div className="results-body--pollution-box">
      <div className="pollution-box">
        <div className="pollution-box--title">
          <span>Air Pollution Levels</span>
        </div>
        <div className="pollution-box--data">
          <span>
            ...
            {data &&
              ...
              data.current.pollution.aqius < 101 &&
              `Moderately Healthy`}
            {data &&
            ...
            {data &&
              data.current.pollution.aqius > 201 &&
              data.current.pollution.aqius < 301 &&
              `Very Unhealthy`}
            {data &&
              data.current.pollution.aqius > 301 &&
              `Downright Hazardous`}
      ...
      <div className="pollution-box">
        ...
        <div className="pollution-box--data">
          <span>
            {data && `${data && data.current.pollution.aqius} US AQI`}
          </span>
        </div>
      </div>
      <div className="pollution-box">
        <div className="pollution-box--title">
          <span>Description of Air Quality</span>
        </div>
        <div className="pollution-box--data">
          {data &&
            data.current.pollution.aqius <= 50 &&
