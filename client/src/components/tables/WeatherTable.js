  ...
  return (
    <div className="results-body--pollution-box">
      <div className="pollution-box">
        <div className="pollution-box--title">
      ...
      <div className="pollution-box">
        ...
        <div className="pollution-box--data">
          <span>{data && `${data.current.weather.hu}%`}</span>
        </div>
      </div>
      <div className="pollution-box weather-data">
        ...
        <div className="pollution-box--data">
          {data && data.current.weather.ic === "01d" && (
            <img src={`/assets/01d.png`} />
          )}
          {data && data.current.weather.ic === "01n" && (
            <img src={`/assets/01n.png`} />
          )}
          {data && data.current.weather.ic === "02d" && (
            <img src={`/assets/02d.png`} />
          )}
          {data && data.current.weather.ic === "02n" && (
            <img src={`/assets/02n.png`} />
          )}
          {data && data.current.weather.ic === "03d" && (
            <img src={`/assets/03d.png`} />
          )}
          {data && data.current.weather.ic === "03n" && (
            <img src={`/assets/03d.png`} />
          )}
          {data && data.current.weather.ic === "04d" && (
            <img src={`/assets/04d.png`} />
          )}
          {data && data.current.weather.ic === "04n" && (
            <img src={`/assets/04d.png`} />
          )}
          {data && data.current.weather.ic === "09d" && (
            <img src={`/assets/09d.png`} />
          )}
          {data && data.current.weather.ic === "09n" && (
            <img src={`/assets/09d.png`} />
          )}
          {data && data.current.weather.ic === "10d" && (
            <img src={`/assets/10d.png`} />
          )}
          {data && data.current.weather.ic === "10n" && (
            <img src={`/assets/10d.png`} />
          )}
          {data && data.current.weather.ic === "11d" && (
            <img src={`/assets/11d.png`} />
          )}
          {data && data.current.weather.ic === "11n" && (
            <img src={`/assets/11d.png`} />
          )}
          {data && data.current.weather.ic === "13d" && (
            <img src={`/assets/13d.png`} />
          )}
          {data && data.current.weather.ic === "13n" && (
            <img src={`/assets/13d.png`} />
          )}
          {data && data.current.weather.ic === `50d` && (
            <img src={`/assets/50d.png`} />
          )}
          {data && data.current.weather.ic === `50n` && (
            <img src={`/assets/50d.png`} />
          )}
